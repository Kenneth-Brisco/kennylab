  ...
  return (
    <div className="contact">
      <a
        ...
        href="https://github.com/Kenneth-Brisco"
        title="GitHub"
        target="_blank"
      ...
      <a
        className="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2"
        href="https://www.linkedin.com/in/kenneth-b-33b51a147/"
        title="LinkedIn"
        target="_blank"
        rel="noopener noreferrer"
      >
      ...
      <a
        ...
        href=" https://medium.com/@kennybriscodev"
        title="Medium"
        target="_blank"
        rel="noopener noreferrer"
      >
      ...
      <a
        class="no-underline near-white bg-animate bg-near-black hover-bg-gray inline-flex items-center ma2 tc br2 pa2"
        href="https://twitter.com/kennybrisco"
        title="Twitter"
        target="_blank"
        rel="noopener noreferrer"
      >
